...
# Get Nairobi's path then populate 53 covariate features and their labels (mask)
abspath_curr=os.getcwd()+os.sep+'nairobi'+os.sep+'nairobi'+os.sep
spfea144= sorted(glob(abspath_curr+'nairobi_covariate_feature_53'+os.sep+'nairobi'+os.sep+'covariate_100m_53'+os.sep+'*.tif'))
mask= sorted(glob(abspath_curr+'nairobi_covariate_feature_53'+os.sep+'nairobi'+os.sep+'covariate_mask_100m'+os.sep+'*.tif'))
...
X_test_list= [f'/home/ubuntu/capstone/nairobi/nairobi/nairobi_covariate_feature_53/nairobi/covariate_100m_53/nai_area{i}.tif' for i in [11,13,20,23,25,28]]
...
y_test_list= [f'/home/ubuntu/capstone/nairobi/nairobi/nairobi_covariate_feature_53/nairobi/covariate_mask_100m/nai_area{i}.tif' for i in [11,13,20,23,25,28]]
...
# Export to parquet
nairobi_df.to_parquet('nairobi_covariate_df.parquet.gzip',compression='gzip')