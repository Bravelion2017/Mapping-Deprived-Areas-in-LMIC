...
nairobi= pd.read_parquet('nairobi_contextual_100_df.parquet.gzip')
...
important_100= important.features.unique()
...
#%%
# Trying SVD again with most important 100 features
X1= X.loc[:,X.columns.isin(important_100)]
# computing singular values using numpy
...
#The Condition number reduced close to half
...
moderate_cor_features= vif_features.index #46
