...
spfea= sorted(glob(abspath_curr+'lagos_rgb_100m'+os.sep+'rgb_100m'+os.sep+'*.tif'))
mask= sorted(glob(abspath_curr+'lagos_rgb_100m'+os.sep+'rgb_mask_100m'+os.sep+'*.tif'))
...
X_test_list= [f'/home/ubuntu/capstone/Lagos/lagos_rgb_100m/rgb_100m/lag_area{i}.tif' for i in [11,13,20,23,25,28]]
...
y_test_list= [f'/home/ubuntu/capstone/Lagos/lagos_rgb_100m/rgb_mask_100m/lag_area{i}.tif' for i in [11,13,20,23,25,28]]
...
# Export to parquet
lagos_df.to_parquet('lagos_rgbn100m_df.parquet.gzip',compression='gzip')